...
LogLevel::Level LogLevel::FromString(const std::string &str) {
  static const std::unordered_map<std::string, LogLevel::Level> levelMap = {
      {"debug", LogLevel::Level::DEBUG}, {"info", LogLevel::Level::INFO},
      {"warn", LogLevel::Level::WARN},   {"error", LogLevel::Level::ERROR},
      {"fatal", LogLevel::Level::FATAL}, {"DEBUG", LogLevel::Level::DEBUG},
