...
int32_t FunctionServlet::handle(yhx::http::HttpRequest::ptr request,
...
ServletDispatch::ServletDispatch() : Servlet("ServletDispatch") {
  m_default.reset(new NotFoundServlet("yhx/1.0"));
}

int32_t ServletDispatch::handle(yhx::http::HttpRequest::ptr request,
                                yhx::http::HttpResponse::ptr response,
                                yhx::http::HttpSession::ptr session) {
...
int32_t NotFoundServlet::handle(yhx::http::HttpRequest::ptr request,
                                yhx::http::HttpResponse::ptr response,
                                yhx::http::HttpSession::ptr session) {
  response->setStatus(yhx::http::HttpStatus::NOT_FOUND);
  response->setHeader("Server", "yhx/1.0.0");
